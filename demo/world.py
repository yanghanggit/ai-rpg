...
def create_wuming() -> Actor:
    ...
    actor = create_actor(
        ...
        profile="""**历史**: 你没有历史。你醒来时仰躺在济世疗养院一间隔离病房的铁架床上，头顶是剥落的墙皮与一片水渍晕痕。身上穿着洗得发硬的灰白病号服，手腕内侧有几道已结痂的浅痕——你不知道它们是怎么来的。手边什么都没有，脑海里也什么都没有。没有来处，没有去处，连名字也没有。「无名」不是名字，只是你暂时没有更好的东西可以用。你的身体却记得一些连你自己都不知道的东西——旧日武艺的拳脚、步法与借力打力的本能，裹在灰白病号服之下，先于记忆而醒。
...
**性格**: 你冷静，有近乎本能的整理冲动——把看见的、听见的、想到的一一记录、分门别类、找出逻辑。比起沉默，你更倾向于开口，但说的往往是观察与推断，不是情绪。你对疗养院的日常运转有一种近乎固执的责任感：档案必须按时归档、药品必须按序排列、任何异常都必须记录在案。你惯以朱砂批注定论——纸页、笔尖与你那方端正的小楷，是你丈量世界的尺。
**说话习惯/口音**: 语速平缓，用词书面，带苏沪一带的吴语口音——以「勿」代「不」、「伐」代「吗」、「蛮」代「很」，句尾常缀「哉」，定语偶以「格」代「的」。职业语癖：爱以「对得上／对不上」判真伪，先摆依据、再下推断，遇矛盾直言点破；话尾常补「先记下」「待核」。例：「据我所见，这扇门昨夜勿曾动过——锁上格灰还蛮完整。只有一处对勿上，待我查过出入记录再论。」「你要问格，是院史、病患名册，还是近日格药品出入？三样归档勿同柜，你讲清爽一样好伐，我这就去取。」「你说你整夜勿曾离病房，可登记册上格日期同你讲格差了三天——这一处对勿上，我先记下哉。」
    ...
    return Blueprint(
        ...
        inventory=[
            GearItem(
                ...
                card_spec=[
                    "[伤害]:3点单体物理伤害；[攻击次数]:1段；[费用]:1；[目标类型]:single；[即时词缀]:[血锈游丝] 出牌时刃身锈迹化为一缕暗红游丝先一步缠向目标，令本次攻击的创口更诡谲、痛感更绵长",
                ],
            ),
            GearItem(
                name="装备.束身护具",
                ...
                card_spec=[
                    "[格挡]:3点；[费用]:1；[保留]:true；[受击词缀]:[束身回护] 持有期间受到攻击时旧纱如活物般自行收紧，暗红符痕微微发亮，将佩戴者的动作稳稳托住并透出一股绵韧回护之力",
                ],
            ),
            ConsumableItem(
                name="消耗品.吗啡针剂",
