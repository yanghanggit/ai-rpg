...
shadow_dragon_md = extract_md_content("/actor/npc/shadow_dragon.md")
...
add_routes(
    ...
    path="/actor/npc/shadow_dragon"
)

if __name__ == "__main__":
    import uvicorn
    uvicorn.run(app, host="localhost", port=8028)


#"http://localhost:8028/actor/npc/shadow_dragon/"