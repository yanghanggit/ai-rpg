...
# from gameplay_systems.components import StageComponent, ActorComponent, PlayerComponent
# from rpg_game.rpg_entitas_context import RPGEntitasContext
# from loguru import logger
# from gameplay_systems.stage_director_component import (
...
#         for entity in self._context.get_group(
#             Matcher(all_of=[StageComponent, StageDirectorComponent])
#         ).entities:
#             entity.get(StageDirectorComponent).clear()

#         for entity in self._context.get_group(
#             Matcher(all_of=[ActorComponent, OnEnterStageComponent])
#         ).entities.copy():
...
#                 self._context, actor_entity, None
#             )
