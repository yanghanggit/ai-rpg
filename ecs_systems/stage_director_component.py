...
##############################################################################################################################################################
    def to_actor(self, target_actor_name: str, extended_context: RPGEntitasContext) -> List[str]:
        return self._to_actor(target_actor_name, extended_context, self._director_events)
##############################################################################################################################################################
    def _to_actor(self, target_actor_name: str, extended_context: RPGEntitasContext, director_events: List[IStageDirectorEvent]) -> List[str]:
        ret: List[str] = []
...
##############################################################################################################################################################
    def to_stage(self, target_stage_name: str, extended_context: RPGEntitasContext) -> List[str]:
        return self._to_stage(target_stage_name, extended_context, self._director_events)
##############################################################################################################################################################
    def _to_stage(self, target_stage_name: str, extended_context: RPGEntitasContext, director_events: List[IStageDirectorEvent]) -> List[str]:
        ret: List[str] = []
        for event in director_events:
...
##############################################################################################################################################################
    def to_player(self, target_actor_name: str, extended_context: RPGEntitasContext) -> List[str]:
        return self._to_player(target_actor_name, extended_context, self._director_events)
##############################################################################################################################################################
    def _to_player(self, target_actor_name: str, extended_context: RPGEntitasContext, director_events: List[IStageDirectorEvent]) -> List[str]:
