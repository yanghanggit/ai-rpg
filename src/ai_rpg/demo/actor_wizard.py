...
**最爱**：你喜欢收集各种小机械装置和发明,最爱的食物是蜂蜜蛋糕和薄荷茶。
  """,
    ...
    actor.skills = [
        ...
        Skill(
            name="法杖聚焦",
            description="引导法杖，释放一道高纯度的魔力射线贯穿敌人。但过载输出会导致法杖过热发红，下一回合无法使用任何需要法杖引导的魔法。",
        ),
        Skill(
            name="精灵密语",
            description="通过古老的精灵语言与自然元素沟通，能够短暂增强队友的魔法抗性和恢复能力。但使用后施法者的精神会感到疲惫，下一回合的魔法效果减弱。",
        ),
        Skill(
            name="古卷洪流",
            description="一次性激活多卷符文卷轴，形成不可预测的魔法风暴轰炸区域。但消耗大量魔力，且混乱的魔力流有概率反噬自身。",
        ),
    ]
