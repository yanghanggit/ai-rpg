...
**最爱**: 你最爱大块烤肉和烈性黑麦酒。""",
    ...
    warrior.skills = [
        ...
        Skill(
            name="物体利用",
            description="通过自身力量利用环境中的物体或使用自身装备，将其转化为攻击或防御的手段。但过度驱使会导致物体损坏，且施法者需要分散注意力维持控制。",
        ),
        Skill(
            name="怒气姿态",
            description="摆出威慑性的战斗姿态，激发体内狂暴力量，大幅提升攻击力和气势。但盛怒状态会削弱理智判断，导致防御力下降且命中率降低。",
        ),
        Skill(
            name="最后一击",
        ...
        Skill(
            name="利刃斩击",
            description="挥舞近战武器，对敌人护甲造成毁灭性的切割伤害，使用钝器时伤害减半。但会导致武器过热，下一回合无法使用该武器，且手臂因剧烈震动而暂时麻木，命中率下降。",
        ),
        Skill(
            name="无畏冲锋",
