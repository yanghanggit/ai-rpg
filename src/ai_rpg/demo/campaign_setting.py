...
(环绕封印之塔——一座刻满古老符文的方尖碑,塔顶供奉圣剑「晨曦之刃」,以曙光之力封印魔王玛拉凯斯)。三大势力维系秩序:星辉学院钻研魔法与考古,银叶秘苑调和自然与魔网,砺石角斗场锤炼战士。然而,城市各处正发生异变:
未知魔法造成的时空裂隙不定时随机出现,魔网紊乱引发魔法失效,裂隙后方的未知地牢遗迹中涌出扭曲的金属魔物,淡紫色「金属瘴气」(散发致幻毒雾)蔓延,符文异变成未知字符闪烁,回荡着诡异的机械轰鸣。尘烟裂谷的五大帮派——铁齿帮、暗影信使、瘴气拾荒者、裂隙医师协会和遗迹掘客团,
通过「裂谷议会」争夺时空裂隙探索权。冒险者作为游离力量,深入这危险的裂隙与地牢遗迹调查真相,其抉择将动摇三族联盟与城市存亡。"""
############################################################################################################
# 艾尔法尼亚世界知识库数据
