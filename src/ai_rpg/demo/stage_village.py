...
空气中混杂着兽皮的麝香、竹木的清香与草药的苦味。这里是猎人们深入山林前整备装备、修整器械的专属场所，提供绝对的安全与充足的物资补给。""",
        ),
...
空气中飘散着桃花酒的清香与炖肉的醇厚香气。猎人们在此分享狩猎经验，长者们讲述避秦先祖的往事，年轻人交换着关于山魈出没与精怪异动的最新情报。这里既是温暖的聚会之所，也是村落的情报枢纽。""",
        ),
        campaign_setting=RPG_CAMPAIGN_SETTING,
        system_rules=RPG_SYSTEM_RULES,
        combat_mechanics=RPG_COMBAT_MECHANICS,
