...
from systems.components import (BroadcastActionComponent, SpeakActionComponent, StageComponent, ActorComponent, AttackActionComponent, PlayerComponent, 
...
class PlayerCommand(ABC):
    ...
    def add_human_message(self, entity: Entity, newmsg: str) -> None:
        self.game.extended_context.safe_add_human_message_to_entity(entity, newmsg)
####################################################################################################################################
####################################################################################################################################
####################################################################################################################################
class PlayerLogin(PlayerCommand):
    ...
    def execute(self) -> None:
        context = self.game.extended_context
