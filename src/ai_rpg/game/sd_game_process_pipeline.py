...
# class SDGameProcessPipeline(Processors):

#     @staticmethod
#     def create_main_pipline(game: BaseGame) -> "SDGameProcessPipeline":

#         ### 不这样就循环引用
#         from ..game.sd_game import SDGame
#         from ..game_systems.sd_kick_off_system import SDKickOffSystem
#         from ..game_systems.sd_test_system import SDTestSystem

#         ##
#         sd_game = cast(SDGame, game)
#         processors = SDGameProcessPipeline("Main Pipeline")

#         # 启动agent的提示词。启动阶段
#         processors.add(SDKickOffSystem(sd_game))

#         # 测试系统
#         processors.add(SDTestSystem(sd_game))
#         # # 规划逻辑
#         # ######## 在所有规划之前!##############################################################
...
#     ###################################################################################################################################################################
#     # @staticmethod
#     # def create_player_home_pipline(game: BaseGame) -> "SDGameProcessPipeline":
...
#     #     processors = SDGameProcessPipeline("Home State Pipeline 2")
...
#     #     ##
#     #     tcg_game = cast(TCGGame, game)
#     #     processors = SDGameProcessPipeline("Dungeon Combat State Pipeline")
