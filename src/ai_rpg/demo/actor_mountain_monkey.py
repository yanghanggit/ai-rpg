...
def create_actor_mountain_monkey() -> Actor:
    ...
    mountain_monkey = create_actor(
        ...
        character_sheet=CharacterSheet(
            ...
            profile="你是武陵山脉深处的山魈，一种介于野兽与精怪之间的猴类妖兽。长年栖息于古先民遗迹附近，因吸收遗迹残留的微弱灵气而变得异常机敏狡猾。你擅长利用周围环境作战，会捡起石块投掷，折断树枝挥舞。虽然单体实力不强，但你懂得观察猎人的破绽，寻找时机突袭。你对侵入领地者充满敌意，但面对强敌时也会选择逃跑。",
            base_body="",
