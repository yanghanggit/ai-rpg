...
from src.multi_agents_game.entitas import Context, Entity, Matcher, Group
from src.multi_agents_game.entitas.exceptions import MissingEntity
...
class TestContext:
    ...
    def test_destroy_entity_success(self):
    ...
    def test_destroy_entity_missing(self):
    ...
    def test_get_group_new_matcher(self):
    ...
    def test_get_group_existing_matcher(self):
    ...
    def test_get_group_with_existing_entities(self):
    ...
    def test_group_updates_on_component_add(self):
    ...
    def test_group_updates_on_component_remove(self):
    ...
    def test_group_updates_on_component_replace(self):
        ...
        group.update_entity.assert_called_once_with(entity, old_pos, new_pos)

    def test_multiple_groups_same_entity(self):
    ...
    def test_event_wiring_on_entity_creation(self):
        """Test that entity events are properly wired to context handlers."""
        context = Context()
        entity = context.create_entity()
        
        # Mock context handlers
        context._comp_added_or_removed = Mock()
        context._comp_replaced = Mock()
        ...
        entity.add(Position, 10, 20)
        context._comp_added_or_removed.assert_called_once()
        
        # Replace component - should trigger handler
        entity.replace(Position, 30, 40)
        context._comp_replaced.assert_called_once()
    ...
    def test_complex_scenario(self):
        ...
        # Create groups
        all_entities_group = context.get_group(Matcher(any_of=(Position, Health, Velocity)))
    ...
    def test_entity_lifecycle_in_context(self):
