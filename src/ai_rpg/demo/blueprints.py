...
副本是独立的冒险内容单元，非地理概念，其主题环境不预设为任意特定地形，可呈任意形态。

生成副本时，须从游戏设定的六大生态区域中选取**一个**作为本次副本的环境底色：
...
六者须均匀轮换选取，禁止默认或倾向性地选择「地上洞穴与山岩」「地下暗河」等地下/洞穴类生态。所选生态决定副本与各场景的命名倾向、感官氛围与生物习性；后续所有步骤须以此为底色严格展开，禁止跨生态混搭（除非选取的区域本身存在生态交界地带）。
