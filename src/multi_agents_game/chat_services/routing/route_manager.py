...
from .route_strategy import RouteStrategy, RouteDecision, FallbackRouteStrategy
...
class RouteDecisionManager:
    ...
    def __init__(self, strategy_weights: List[StrategyWeight], 
        ...
        self.fallback_strategy = fallback_strategy or FallbackRouteStrategy(default_to_rag=False)
    ...
    def make_decision(self, query: str, context: Optional[Dict[str, Any]] = None) -> RouteDecision:
        """
        进行路由决策
...
class RouteConfigBuilder:
    ...
    def add_strategy(self, strategy: RouteStrategy, weight: float) -> 'RouteConfigBuilder':
        """添加策略"""
