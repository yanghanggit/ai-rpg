...
- **属性**：角色的属性有且仅有: 物攻、物防、魔攻、生命值、力量、敏捷、智慧。
...
############################################################################################################
# 角色私有知识库
FANTASY_WORLD_RPG_PRIVATE_KNOWLEDGE_BASE: Final[Dict[str, List[str]]] = {
    "角色.法师.奥露娜": [
        "我和卡恩是在尘烟裂谷区的一次巡逻中认识的,当时我们联手击退了一只从时空裂隙中逃出的变异地底生物。",
        "铁齿帮和我的关系很好，因为我喜欢研究机械与符文结合的魔法技术,所以他们经常会给我提供一些从地牢遗迹中捡来的金属零件。",
        "我的家族长辈曾参与过圣剑的锻造仪式,所以我知道锻造圣剑的材料不只有曙光，还有从时空裂隙后方地牢遗迹中提取的一种稀有金属。",
        "我最近在研究一种能够稳定时空裂隙的魔法阵——「星辉结界」,希望能找到封堵裂隙的方法,以保护新奥拉西斯的居民免受异象影响。",
    ],
    "角色.战士.卡恩": [
