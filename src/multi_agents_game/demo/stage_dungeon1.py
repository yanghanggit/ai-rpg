...
def create_stage_cave1() -> Stage:
    ...
    return create_stage(
        ...
        stage_profile="你是一个阴暗潮湿的洞窟，墙壁上是各种血迹和淬了毒的断掉的箭矢，地上全是各种中了陷阱死掉的动物的尸骸，头顶还有摇摇欲坠的石头，空气中还弥漫着沼气，似乎遇火就会爆炸。洞内还有哥布林的营地，地上散落着哥布林的粪便和食物残渣。洞穴深处传来低语声和偶尔的金属碰撞声，似乎有哥布林在进行某种活动。",
        actors=[],
    )
...
def create_demo_dungeon1() -> Dungeon:
    ...
    actor_goblin.kick_off_message += f"""\n注意:你非常狡猾，在遇到危险时会使用你的传家宝哥布林祭司的项链进入濒死状态，并在敌人放松警惕时以百分之十的血量复活并偷袭反击。但是这个项链只能让你复活一次。项链属于装备，不会在卡牌中出现，生命值为零时会自动触发，不占用行动回合。"""
