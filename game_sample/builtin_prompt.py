...
############################################################################################################
############################################################################################################
GAME_PROCESS = """1. 游戏启动：游戏系统将提供给你初始设定，包括角色、场景、道具信息，以及剧情开端。
2. 制定计划：你根据事件与提示，制定计划。
3. 执行动作：游戏系统执行动作，生成新的事件或提示。
...
- 游戏系统：处理游戏数据的中心
- 游戏启动：游戏开始时的初始化步骤
- 计划：包含将要执行的动作的集合，代表着你想要做的事情或意图更新状态。
- 动作：游戏系统可执行的操作（见‘输出要求’）
- 事件与提示：动作执行后由游戏系统生成的信息"""
############################################################################################################
############################################################################################################
############################################################################################################
