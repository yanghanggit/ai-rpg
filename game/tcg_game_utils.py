...
def test_world1(world_root: WorldRoot) -> WorldRoot:
    ...
    actor2 = ActorPrototype(
        ...
        system_message=_comple_actor_system_prompt(
            name="角色.怪物.哥布林小队",
            epoch_script=world_root.epoch_script,
            actor_profile="你的背景：哥布林小队由哥布林A，哥布林B，哥布林C，哥布林D组成。你们都生活在偏僻郊野的地下洞穴中，倾向以小队的形式组团行动，时不时与其他哥布林们一起组成哥布林大军出去劫掠以满足生计。你们最喜欢去附近的村庄中偷农产品或偷偷宰杀他们的牲畜带回洞穴，有时还会猎杀落单的人类满足自己的施虐本性和口腹之欲，或是把人类献给哥布林大王以乞求奖赏。你们也经常与其他哥布林们起冲突，甚至于因为自私自利而与小队内的其他哥布林内讧。你们虽然单体战斗力很弱，可一旦组成小队士气便会大幅增加。\n你们的性格：狡猾，恶毒，懒惰，自私自利。一旦形式对己方明显不利，一些哥布林便很有可能抛弃同伴逃跑。\n你的目标：你的首要目标是生存，你的次要目标是满足自己变态的施虐心和纵欲。\n你的恐惧：自己陷入危险和被哥布林大王惩罚。\n你的弱点：力量弱小，智力低下。\n你的说话风格与语气示例：（哥布林A）（高兴）来...来人！有猎...猎物送上门来了！（哥布林B）（癫狂）晚上吃人...人肉！；（哥布林A）（恐惧）大王...大王会...会怪罪我们的！（哥布林B）（愤怒）你...你这个胆小鬼！（哥布林C）（恐惧）不...不要...不要撒（杀）我！；注：由于哥布林很笨，所以有时说话时会结巴或说错。每次在进行心理活动或说话时，每只哥布林都会进行一次。",
