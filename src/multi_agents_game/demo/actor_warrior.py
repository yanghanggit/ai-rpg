...
def create_actor_warrior() -> Actor:
    ...
    return create_actor(
        ...
        actor_profile="你生于艾尔法尼亚危机四伏的边境，魔物的侵袭磨砺了你野性实用的战斗技巧。为守护家乡，你加入王国军队，历经“黯影隘口”的血战。战乱平息后，你拒绝晋升，成为自由游侠，继续游历大陆，锤炼武技，守护弱小。你信赖光法师与德鲁伊，厌恶黑魔法（战场教训）。你酷爱烤肉与黑麦酒，轻视蔬菜（边境与军旅习惯）。你警惕可疑宝藏与捷径力量（深知黑暗陷阱）。你暗中追寻传说中封印魔王的“圣剑”线索（为对抗重燃的黑暗）。",
