...
class ActorAppearanceInitSystem(ExecuteProcessor):
    ...
    async def execute(self) -> None:
        ...
        self._initialize_appearances(actor_entities)

    #######################################################################################################################################
    def _initialize_appearances(self, actor_entities: Set[Entity]) -> None:
        ...
        for actor_entity in actor_entities:
            ...
            self._game.add_human_message(
                actor_entity,
                _format_appearance_update_notification(appearance_comp.base_body),
            )
