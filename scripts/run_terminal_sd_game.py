...
# #######################################################################################################################################
# # TODO, 临时添加行动, 逻辑。
# def _plan_action(terminal_game: TerminalSDGame, actors: List[str]) -> None:
...
# #######################################################################################################################################
# # TODO, 临时添加行动, 逻辑。
# def _trans_stage_action(terminal_game: TerminalSDGame, stage_name: str) -> bool:
...
#     terminal_game: TerminalSDGame, usr_input: str
# ) -> None:
#     """处理地下城状态下的玩家输入"""
