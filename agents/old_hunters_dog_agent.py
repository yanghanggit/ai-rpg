...
old_hunters_dog_md = extract_md_content("/actor/npc/old_hunters_dog.md")
...
add_routes(
    ...
    path="/actor/npc/old_hunters_dog"
)

if __name__ == "__main__":
    import uvicorn
    uvicorn.run(app, host="localhost", port=8023)


#"http://localhost:8023/actor/npc/old_hunters_dog/"